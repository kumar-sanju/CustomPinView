/**
 * @author Sanjay Mahapatra
 * 08-06-2022
 */
package com.smart.customotpview;
...
public class OtpView extends AppCompatEditText {
    ...
    public OtpView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray typedArray =
                theme.obtainStyledAttributes(attrs, R.styleable.CustomOtpView, defStyleAttr, 0);
        viewType = typedArray.getInt(R.styleable.CustomOtpView_viewType1, VIEW_TYPE_RECTANGLE);
        otpViewItemCount = typedArray.getInt(R.styleable.CustomOtpView_itemCount, DEFAULT_COUNT);
        otpViewItemHeight = (int) typedArray.getDimension(R.styleable.CustomOtpView_itemHeight,
                res.getDimensionPixelSize(R.dimen.otp_view_item_size));
        otpViewItemWidth = (int) typedArray.getDimension(R.styleable.CustomOtpView_itemWidth,
                res.getDimensionPixelSize(R.dimen.otp_view_item_size));
        otpViewItemSpacing = typedArray.getDimensionPixelSize(R.styleable.CustomOtpView_itemSpacing,
                res.getDimensionPixelSize(R.dimen.otp_view_item_spacing));
        otpViewItemRadius = (int) typedArray.getDimension(R.styleable.CustomOtpView_itemRadius, 0);
        lineWidth = (int) typedArray.getDimension(R.styleable.CustomOtpView_lineWidth,
                res.getDimensionPixelSize(R.dimen.otp_view_item_line_width));
        lineColor = typedArray.getColorStateList(R.styleable.CustomOtpView_lineColor);
        isCursorVisible = typedArray.getBoolean(R.styleable.CustomOtpView_android_cursorVisible, true);
        cursorColor = typedArray.getColor(R.styleable.CustomOtpView_cursorColor, getCurrentTextColor());
        cursorWidth = typedArray.getDimensionPixelSize(R.styleable.CustomOtpView_cursorWidth,
                res.getDimensionPixelSize(R.dimen.otp_view_cursor_width));
        itemBackground = typedArray.getDrawable(R.styleable.CustomOtpView_android_itemBackground);
        hideLineWhenFilled = typedArray.getBoolean(R.styleable.CustomOtpView_hideLineWhenFilled, false);
        rtlTextDirection = typedArray.getBoolean(R.styleable.CustomOtpView_rtlTextDirection, false);
        typedArray.recycle();
        if (lineColor != null) {
