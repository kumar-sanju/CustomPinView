 ...
 *
 * @author Sanjay Kumar Mahapatra
 * 01/06/2022
 */
public class CustomPinView extends AppCompatEditText {

    private static final String TAG = "CustomPinView";
    ...
    public CustomPinView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mViewType = a.getInt(R.styleable.CustomPinView_viewType, VIEW_TYPE_RECTANGLE);
        mPinItemCount = a.getInt(R.styleable.CustomPinView_itemCount, DEFAULT_COUNT);
        mPinItemHeight = (int) a.getDimension(R.styleable.CustomPinView_itemHeight,
                res.getDimensionPixelSize(R.dimen.pv_pin_view_item_size));
        mPinItemWidth = (int) a.getDimension(R.styleable.CustomPinView_itemWidth,
                res.getDimensionPixelSize(R.dimen.pv_pin_view_item_size));
        mPinItemSpacing = a.getDimensionPixelSize(R.styleable.CustomPinView_itemSpacing,
                res.getDimensionPixelSize(R.dimen.pv_pin_view_item_spacing));
        mPinItemRadius = (int) a.getDimension(R.styleable.CustomPinView_itemRadius, 0);
        mLineWidth = (int) a.getDimension(R.styleable.CustomPinView_lineWidth,
                res.getDimensionPixelSize(R.dimen.pv_pin_view_item_line_width));
        mLineColor = a.getColorStateList(R.styleable.CustomPinView_lineColor);
        isCursorVisible = a.getBoolean(R.styleable.CustomPinView_android_cursorVisible, true);
        mCursorColor = a.getColor(R.styleable.CustomPinView_cursorColor, getCurrentTextColor());
        mCursorWidth = a.getDimensionPixelSize(R.styleable.CustomPinView_cursorWidth,
                res.getDimensionPixelSize(R.dimen.pv_pin_view_cursor_width));

        mItemBackground = a.getDrawable(R.styleable.CustomPinView_android_itemBackground);
        mHideLineWhenFilled = a.getBoolean(R.styleable.CustomPinView_hideLineWhenFilled, false);
    ...
    private void drawCustomPinView(Canvas canvas) {
     ...
     * @attr ref R.styleable#CustomPinView_lineColor
    ...
    /**
     * Gets the line colors for the different states (normal, selected, focused) of the CustomPinView.
     *
     * @attr ref R.styleable#CustomPinView_lineColor
     * @see #setLineColor(ColorStateList)
     * @see #setLineColor(int)
     ...
     * Sets the line width.
     *
     * @attr ref R.styleable#CustomPinView_lineWidth
     * @see #getLineWidth()
     */
     ...
     *
     * @attr ref R.styleable#CustomPinView_itemCount
     * @see #getItemCount()
     */
     ...
     *
     * @attr ref R.styleable#CustomPinView_itemRadius
     * @see #getItemRadius()
     */
     ...
     *
     * @attr ref R.styleable#CustomPinView_itemSpacing
     * @see #getItemSpacing()
     */
     ...
     *
     * @attr ref R.styleable#CustomPinView_itemHeight
     * @see #getItemHeight()
     */
     ...
     *
     * @attr ref R.styleable#CustomPinView_itemWidth
     * @see #getItemWidth()
     */
     ...
     * @attr ref R.styleable#CustomPinView_hideLineWhenFilled
     */
     ...
     * @attr ref R.styleable#CustomPinView_android_itemBackground
     */
     ...
     *
     * @attr ref R.styleable#CustomPinView_cursorWidth
     * @see #getCursorWidth()
     */
     ...
     *              Do not pass a resource ID. To get a color value from a resource ID, call
     *              {@link androidx.core.content.ContextCompat#getColor(Context, int) getColor}.
     * @attr ref R.styleable#CustomPinView_cursorColor
     * @see #getCursorColor()
     */
